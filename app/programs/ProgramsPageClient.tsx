      ...
      <section aria-labelledby="faq-heading" style={{ padding: 'var(--section) 0', background: 'var(--bg)' }}>
        <div className="container">
          <AnimatedSection style={{ marginBottom: '64px' }}>
            ...
            <h2 id="faq-heading" style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(34px, 4vw, 50px)', fontWeight: 400, color: 'var(--cream)', lineHeight: 1.1, letterSpacing: '-0.01em', maxWidth: '600px' }}>
          ...
          <div style={{ maxWidth: '760px', display: 'flex', flexDirection: 'column', gap: 0 }}>
            {[
              {
                q: 'How much does chess coaching cost in Abu Dhabi?',
                a: 'Adarsh Shankar offers private 1-on-1 chess coaching and small group sessions (maximum 4 students) in Abu Dhabi and Dubai. Pricing is discussed directly during the free 20-minute intro call, which has no commitment.',
              },
              {
                q: 'Is online chess coaching as effective as in-person?',
                a: 'Yes. Adarsh conducts online sessions via WhatsApp video, Zoom, or Google Meet with full session notes and game recordings. Students across India, the USA, and UAE have achieved significant rating gains through online coaching.',
              },
              {
                q: 'What level do I need to be to start chess coaching?',
                a: 'No experience is required. The Foundations program starts from the very basics — pieces, rules, and first moves. Adarsh coaches complete beginners through to UAE tournament competitors.',
              },
              {
                q: 'How long before I see improvement in my chess rating?',
                a: 'Results vary by starting level and session frequency. One student improved from 700 to 1500 on Lichess in one year. A 6-year-old student went from zero experience to winning school tournaments within a year of coaching.',
              },
              {
                q: 'Does Adarsh coach children?',
                a: 'Yes. Adarsh coaches students of all ages, including young children. A parent reported their 6-year-old son won school tournaments after one year of 1-on-1 coaching with Adarsh.',
              },
            ].map((faq, i) => (
              <AnimatedSection key={i} delay={i * 0.08}>
                <div style={{ borderTop: '1px solid var(--border)', padding: '28px 0' }}>
                  <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '20px', fontWeight: 400, color: 'var(--cream)', lineHeight: 1.3, marginBottom: '12px' }}>{faq.q}</h3>
