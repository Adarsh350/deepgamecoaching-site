...
import type { LichessRatings } from '@/lib/lichess';
...
export default function HomeClient({ ratings }: Props) {
  const shouldReduceMotion = useReducedMotion();
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px', alignItems: 'center' }}>
            <AnimatedSection variant="fadeLeft">
              ...
              {/* Count-up stats — live from Lichess API */}
              <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginBottom: '32px' }}>
                {[
                  { num: ratings.blitz.toString(), label: 'Lichess Blitz' },
                  { num: ratings.rapid.toString(), label: 'Lichess Rapid' },
